...
- секции могут быть переконфигурированы в кодогенераторе
...
- На одни и те же инструкции (команды и данные) могут быть указаны несколько меток, однако метки не могут дублировать и соответсвенно также указывать на разные инструкции.
...
* Память данных:
    ...
    * Может быть прочитана в регистр data_address.
    j
